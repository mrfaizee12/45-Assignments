...
// I really love pizza!
    ...
    let pizzas: string[] =["marghareta", "Fajita","Haawaiin"];
...
// make a great pet!
    ...
    let petAnimals: string[] = ["Dog", "Horse", "Cat"];
// using for-loop
...
function makeShirt (size: string = "Large", printMessage: string = "I love Programming"){
...
function show_magicians1(magicians: string[]){
  ...
  let copy_great_magicians: string[] = make_great1(copyMagicians);
