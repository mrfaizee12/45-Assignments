...
let guestList0 = ["Cena", "Robert"];
let count_guestList = guestList0.length;
...
let university = { uniName: "Karachi University",
...
let students = ["Aamir", "Munir", "Raza", "Usama"];
...
let favoriteFruits = ["Melon", "Strawberry", "Mango"];
